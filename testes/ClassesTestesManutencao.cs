    ...
    class ClassesTestesManutencao
    {
        private class TestesExpressoes : SuiteClasseTestes
        {
            ...
            public void Teste_Dois(AssercaoSuiteClasse assercao)
            {
                ...
                assercao.IsTrue(
                    (this.escopo.tabela.GetVar("c", this.escopo) != null) &&
                    (float.Parse(this.escopo.tabela.GetVar("c", this.escopo).valor.ToString()) == 2.2f));
            }
            ...
            public void Teste_Tres(AssercaoSuiteClasse assercao)
            {
                ...
                assercao.IsTrue(
                    (this.escopo.tabela.GetVar("c", this.escopo) != null) &&
                    (int.Parse(this.escopo.tabela.GetVar("c", this.escopo).valor.ToString()) == 300));
            ...
            public void Teste_Um(AssercaoSuiteClasse assercao)
            {
                ...
                assercao.IsTrue(int.Parse(this.escopo.tabela.GetVar("c", this.escopo).valor.ToString()) == 3);
            }
        ...
        public class TestesAvaliacaoDeInstrucoes : SuiteClasseTestes
        {
            ...
            public void TesteChamadaDeObjetoImportado(AssercaoSuiteClasse assercao)
            {
                ...
                string codigoImportador = "importer (ParserLinguagemOrquidea.exe);";
                string codigoCreate = "Matriz M= create(1,1);";
                string codigoChamadaMetodo = "M.SetElement(0,0, 1.0)";

                string codigoTotal = codigoImportador + " " + codigoCreate + " " + codigoChamadaMetodo;
                ProcessaTestes(codigoTotal);

                assercao.IsTrue(processador.escopo.tabela.GetVar("M", processador.escopo) != null);
            }
            ...
            public void TesteCreateObjects(AssercaoSuiteClasse assercao)
            {
                ...
                string codigoTotal = codigoImportador + " " + codigoCreate;
                ProcessaTestes(codigoTotal);
            ...
            public void TesteCasesOfUse(AssercaoSuiteClasse assercao)
            {
                ...
                assercao.IsTrue(int.Parse(this.processador.escopo.tabela.GetVar("a", processador.escopo).GetValor().ToString()) == 6);
            ...
            public void TesteCasesOfUse_2(AssercaoSuiteClasse assercao)
            {
                ...
                this.ProcessaTestes(codigo);
                assercao.IsTrue(int.Parse(processador.escopo.tabela.GetVar("a", processador.escopo).GetValor().ToString()) == 5);
            }
            public void TesteWhile(AssercaoSuiteClasse assercao)
            {
                ...
                assercao.IsTrue(int.Parse(this.processador.escopo.tabela.GetVar("x", processador.escopo).GetValor().ToString()) == 5);
            }
            ...
            public void Atribuicao(AssercaoSuiteClasse assercao)
            {
                ...
                assercao.IsTrue(
                    ...
                    (int.Parse(processador.escopo.tabela.GetVar("c", processador.escopo).valor.ToString()) == 3));
            }
            ...
            public void TesteIF(AssercaoSuiteClasse assercao)
            {
                ...
                assercao.IsTrue(int.Parse(this.processador.escopo.tabela.GetVar("a", processador.escopo).GetValor().ToString()) == 15);
            }
            ...
            {
                string codigo = "int a=0; int b=5; for (int x=0;x< 2;x++) {a= a+ x;};";
                this.ProcessaTestes(codigo);

                assercao.IsTrue(int.Parse(this.processador.escopo.tabela.GetVar("a", processador.escopo).GetValor().ToString()) == 1);
